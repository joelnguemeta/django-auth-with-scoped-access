...
- ⬜ Migrations Django du package (absentes : les tests passent par run_syncdb), modèles swappables, cache par requête, cas §8.3 (unicité) et §9 (événements), guide de migration DME/APSR, CI, licence.
