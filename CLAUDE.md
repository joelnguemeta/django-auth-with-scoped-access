...
- ⬜ Modèles swappables, cache par requête, extension du format de conformité pour §8.3/§9 (aujourd'hui tests Django only), guide de migration DME/APSR, remote GitHub + premier push, publication PyPI.
